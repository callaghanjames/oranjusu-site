...
initEmailModal({ mailchimpUrl: 'https://icloud.us7.list-manage.com/subscribe/post?u=acc8234cf94f0de5b16b82418&amp;id=dc24663714&amp;f_id=00604de4f0', trackName: "Ain't Got Time" });
...
document.querySelectorAll('a[data-dsp]').forEach((el) => {
  el.addEventListener('click', (e) => {
    ...
    sendBackupPixel("Lead", PIXEL_ID, { dsp, content_name: "Ain't Got Time" });
